    ...
    public class InvoicesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Invoice>>> GetInvoices()
        {
          if (_context.Invoices == null)
          {
            ...
            return await _context.Invoices.Where(w =>  w.State == true).Include(x => x.Details).ThenInclude(y => y.Product).ThenInclude(z => z.Category).ToListAsync();
        }
        ...
        public async Task<IActionResult> DeleteInvoiceFalse(int id)
        {
            if (_context.Invoices == null)
            {
                return NotFound();
